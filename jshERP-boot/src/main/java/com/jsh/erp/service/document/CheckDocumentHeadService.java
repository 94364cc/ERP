...
@Service(value = "checkDocumentHeadService")
public class CheckDocumentHeadService extends AbsDocumentHeadService implements InitializingBean {
    @Autowired
    ...
    public void afterPropertiesSet() throws Exception {
        DocumentStrategyFactory.register(DocumentTypeEnum.CHECK.getType(),this);
    }
    ...
    public String generatNumber(Long supplierId, LocalDate date){
        ...
        return "CK"+supplierId+dateStr+maxStr;
    }
