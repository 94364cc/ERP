    ...
    public String saveDetials(JSONObject obj, String sortList, Long materialId, String type) throws Exception {
        ...
        if (null != insertedJson) {
            for (int i = 0; i < insertedJson.size(); i++) {
                ...
                if (StrUtil.isNotEmpty(tempInsertedJson.getString("barCode"))) {
                ...
                if (StrUtil.isNotEmpty(tempInsertedJson.getString("commodityUnit"))) {
                ...
                if (StrUtil.isNotEmpty(tempInsertedJson.getString("purchaseDecimal"))) {
                    materialExtend.setPurchaseDecimal(tempInsertedJson.getBigDecimal("purchaseDecimal"));
                }
                if (StrUtil.isNotEmpty(tempInsertedJson.getString("commodityDecimal"))) {
                    materialExtend.setCommodityDecimal(tempInsertedJson.getBigDecimal("commodityDecimal"));
                }
                if (StrUtil.isNotEmpty(tempInsertedJson.getString("wholesaleDecimal"))) {
                    materialExtend.setWholesaleDecimal(tempInsertedJson.getBigDecimal("wholesaleDecimal"));
                }
                if (StrUtil.isNotEmpty(tempInsertedJson.getString("lowDecimal"))) {
        ...
        if (null != updatedJson) {
            for (int i = 0; i < updatedJson.size(); i++) {
                ...
                if (StrUtil.isNotEmpty(tempUpdatedJson.getString("barCode"))) {
                ...
                if (StrUtil.isNotEmpty(tempUpdatedJson.getString("commodityUnit"))) {
                ...
                if (StrUtil.isNotEmpty(tempUpdatedJson.getString("purchaseDecimal"))) {
                    materialExtend.setPurchaseDecimal(tempUpdatedJson.getBigDecimal("purchaseDecimal"));
                }
                if (StrUtil.isNotEmpty(tempUpdatedJson.getString("commodityDecimal"))) {
                    materialExtend.setCommodityDecimal(tempUpdatedJson.getBigDecimal("commodityDecimal"));
                }
                if (StrUtil.isNotEmpty(tempUpdatedJson.getString("wholesaleDecimal"))) {
                    materialExtend.setWholesaleDecimal(tempUpdatedJson.getBigDecimal("wholesaleDecimal"));
                }
                if (StrUtil.isNotEmpty(tempUpdatedJson.getString("lowDecimal"))) {
